...
function setMarkerIcon(latlng) {
	//create the icon
	if (main.addItem.mode != "") {
		var myIcon = new GIcon();
		myIcon.image = '../images/markers/' + main.addItem.mode + '/image.png';
		myIcon.shadow = '../images/markers/' + main.addItem.mode + '/shadow.png';
		...
		myIcon.printImage = '../images/markers/' + main.addItem.mode + '/printImage.gif';
		myIcon.mozPrintImage = '../images/markers/' + main.addItem.mode + '/mozPrintImage.gif';
		myIcon.printShadow = '../images/markers/' + main.addItem.mode + '/printShadow.gif';
		myIcon.transparent = '../images/markers/' + main.addItem.mode + '/transparent.png';
