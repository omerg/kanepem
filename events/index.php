  ...
  <div id="main">
    <div id="content">
      	<div id="content-header">
			<div id="profile-box" class="content-header-left-sqr content-box">
				<div id="profile-box" class="profile-box">Profile Data Goes Here</div>
			</div>
			<div id="content-header-data"  class="content-box">
				<div id="events-title">etkinlikler</div>
			</div>
		</div>
		<div id="content-data">
			<div id="content-sidebar-left" class="content-sidebar-left content-box">
				<div id="content-navigation" class="content-navigation">
			...
			<div id="content-main" class="content-main has-right-column content-box">
				<div id="pager-container" class="pager-container">
					<div id="pager-empty-message">etkinlik bulunamadi"</div>
				</div>
			</div>		
